...
// ─── tiny design-system helpers (no s-* web components needed) ───────────────
...
function Heading({ children }) {
  return (
    <h2 style={{ fontSize: "15px", fontWeight: 600, margin: 0 }}>{children}</h2>
  );
}
    ...
    <Page heading="Smart Crop Control Center">
      ...
      <Card>
        <Stack gap="base">
          ...
          <Paragraph>
            This main page combines onboarding, a live API health probe, upload preparation, and
            crop execution so you can validate the integration before processing files.
          </Paragraph>
          <Inline gap="base">
